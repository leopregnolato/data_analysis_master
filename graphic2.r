...
ggplot(tan_sdom, aes(x=St, y=Frequency))
...
+geom_smooth(method="loess", aes(fill=Specie, color=Specie)) + theme_linedraw() +ylim(-25, 100)
+xlim(0, 58) +labs(x = "Areas", y = "Occurrence of frequency (%)")
...
grafico=ggplot(data = tan_sdom, aes(x = St, y = Frequency))
+annotate("rect", xmin = 0, xmax = 18.5, ymin = -10, ymax = 100, alpha = .2, fill = "black")
+annotate("rect", xmin = 18.5, xmax = 39.5, ymin = -10, ymax = 100, alpha = .2, fill = "darkgrey")
